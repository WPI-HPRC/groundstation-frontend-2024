...
public:
    ...
    QMap<QString, std::function<void(dataPoint &, const QJsonValue &)>> elementMap = {
            ...
            {"i",                     [](dataPoint &dp, const QJsonValue &value) {
                dp.i = value.toDouble();
                dp.orientation.setX(value.toDouble());
            }},
            {"k",                     [](dataPoint &dp, const QJsonValue &value) {
                dp.j = value.toDouble();
                dp.orientation.setY(value.toDouble());
            }},
            {"j",                     [](dataPoint &dp, const QJsonValue &value) {
                dp.k = value.toDouble();
                dp.orientation.setZ(value.toDouble());
            }},
            {"w",                     [](dataPoint &dp, const QJsonValue &value) {
                dp.w = value.toDouble();
                dp.orientation.setScalar(value.toDouble());
            }},
            ...
            {"p_satellites",          [](dataPoint &dp,
                                         const QJsonValue &value) { dp.p_numSatellites = value.toInt(); }},
            ...
            {"p_gpsAltMSL",           [](dataPoint &dp,
                                         const QJsonValue &value) { dp.p_gpsAltMSL = value.toDouble(); }},
            {"p_gpsAltAGL",           [](dataPoint &dp,
                                         const QJsonValue &value) { dp.p_gpsAltAGL = value.toDouble(); }},
            ...
            {"p_k",                   [](dataPoint &dp, const QJsonValue &value) {
                dp.p_j = value.toDouble();
                dp.p_orientation.setY(value.toDouble());
            }},
            {"p_j",                   [](dataPoint &dp, const QJsonValue &value) {
                dp.p_k = value.toDouble();
                dp.p_orientation.setZ(value.toDouble());
            }},
            {"p_w",                   [](dataPoint &dp, const QJsonValue &value) {
                dp.p_w = value.toDouble();
                dp.p_orientation.setScalar(value.toDouble());
            }},
            ...
            {"desiredAirbrakes",      [](dataPoint &dp,
                                         const QJsonValue &value) { dp.desiredAirbrakes = value.toDouble(); }},
            {"currentAirbrakes",      [](dataPoint &dp,
                                         const QJsonValue &value) { dp.currentAirbrakes = value.toDouble(); }},
            {"payloadBatteryVoltage", [](dataPoint &dp,
                                         const QJsonValue &value) { dp.payloadBatteryVoltage = value.toDouble(); }},
            {"p_gpsLat",              [](dataPoint &dp, const QJsonValue &value) { dp.p_gpsLat = value.toDouble() /
                                                                                                 pow(10, 7);
            }},
            {"p_gpsLong",             [](dataPoint &dp, const QJsonValue &value) { dp.p_gpsLong = value.toDouble() /
            ...
            {"p_targetGpsLat",        [](dataPoint &dp,
                                         const QJsonValue &value) { dp.p_targetGpsLat = value.toDouble(); }},
            {"p_targetGpsLong",       [](dataPoint &dp,
                                         const QJsonValue &value) { dp.p_targetGpsLong = value.toDouble(); }},
            {"p_actualServoPos1",     [](dataPoint &dp,
                                         const QJsonValue &value) { dp.p_actualServoPos1 = value.toDouble(); }},
            {"p_desiredServoPos1",    [](dataPoint &dp,
                                         const QJsonValue &value) { dp.p_desiredServoPos1 = value.toDouble(); }},
            {"p_actualServoPos2",     [](dataPoint &dp,
                                         const QJsonValue &value) { dp.p_actualServoPos2 = value.toDouble(); }},
            {"p_desiredServoPos2",    [](dataPoint &dp,
                                         const QJsonValue &value) { dp.p_desiredServoPos2 = value.toDouble(); }},
            {"p_actualServoPos3",     [](dataPoint &dp,
                                         const QJsonValue &value) { dp.p_actualServoPos3 = value.toDouble(); }},
            {"p_desiredServoPos3",    [](dataPoint &dp,
                                         const QJsonValue &value) { dp.p_desiredServoPos3 = value.toDouble(); }},
            {"p_actualServoPos4",     [](dataPoint &dp,
                                         const QJsonValue &value) { dp.p_actualServoPos4 = value.toDouble(); }},
            {"p_desiredServoPos4",    [](dataPoint &dp,
                                         const QJsonValue &value) { dp.p_desiredServoPos4 = value.toDouble(); }},
